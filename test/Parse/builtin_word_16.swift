...
i32 = Builtin.truncOrBitCast_Word_Int32(word) // expected-error{{}}
...
word = Builtin.zextOrBitCast_Int32_Word(i32) // expected-error{{}}
...
i16 = Builtin.trunc_Word_Int16(word) // expected-error{{}}
...
word = Builtin.zext_Int16_Word(i16) // expected-error{{}}
